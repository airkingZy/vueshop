<template>
    <div>
        ...
        <div class="container">
          <div class="checkout-addr">
            ...
            <div class="addr-list-wrap">
              <div class="addr-list">
                <ul>
                  <li v-for="(item,index) in addressListFilter" v-bind:class="{'check':checkIndex==index}" @click="checkIndex=index;seletedAddressId=item.addressId">
                    <dl>
                      <dt>{{ item.userName}}</dt>
                  ...
                  <li class="addr-new" @click="addNewAddressFlag">
            ...
            <div class="next-btn-wrap">
              <router-link class="btn btn--m btn--red" v-bind:to="{path:'/orderConfirm',query:{'addressId':seletedAddressId}}">Next</router-link>
            </div>
          </div>
        </div>
      </div>
      ...
      <modal :mdShow="isMdShow&&isAddShow" @click="closeModal">
        <p slot="message">
          添加新的地址
        </p>
        <p slot="succmsg">{{tips}}</p>
        <ul slot="dz">
          <li class="regi_form_input">
            <i class="icon IconPeople"></i>
            <input type="text" tabindex="1" name="loginname" v-model="userName" class="regi_login_input regi_login_input_left"  data-type="loginname" placeholder="收货人姓名">
          </li>
          <li class="regi_form_input noMargin">
            <i class="icon IconPwd"></i>
            <input type="text" tabindex="2"  name="password" v-model="streetName" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="收货地址" >
          </li>
          <li class="regi_form_input noMargin">
            <i class="icon IconPwd"></i>
            <input type="text" tabindex="2"  name="password" v-model="postCode" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="邮编" >
          </li>
          <li class="regi_form_input noMargin">
            <i class="icon IconPwd"></i>
            <input type="text" tabindex="2"  name="password" v-model="tel" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="电话" >
          </li>
        </ul>
        <div slot="btnGroup">
