<template>
    <div>
      ...
      <nav-carouse></nav-carouse>
        <div class="accessory-result-page accessory-page">
          <div class="container">
            <div class="filter-nav">
              <span class="sortby">Sort by:</span>
              <a href="javascript:void(0)" class="default cur">Default</a>
              <a href="javascript:void(0)" class="price" @click="sortGoods" v-bind:class="{'sort-up':sortFlag}">Price <svg class="icon icon-arrow-short"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-arrow-short"></use></svg></a>
...
<script>
  ...
  import NavCarouse from './../components/carousel figure'
      ...
      methods:{
          getGoodsList(flag){
              ...
              axios.get("/goods/list",{
                  ...
                  if(res.status=="0"){
                      if(flag){
                        this.goodsList = this.goodsList.concat(res.resilt.list);
                        if(res.resilt.count=="0"){
                            this.busy = true;
                        }else{
                            this.busy = false;
                        }
                      }else {
                        this.goodsList = res.resilt.list;
                        this.busy = false;
