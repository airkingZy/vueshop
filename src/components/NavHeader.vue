  ...
  <header class="header">
    ...
    <div class="md-modal modal-msg md-modal-transition" v-bind:class="{'md-show':loginModelFlag}">
      <div class="md-modal-inner">
        <div class="md-top">
          <div class="md-title" v-bind:class="{'ddd-actuve':loginFlag}" @click="choselogin">Login in</div>
          <div class="md-title reg-title" v-bind:class="{'ddd-actuve':registerModelFlag}" @click="chosereg">register in</div>
          <button class="md-close" @click="loginModelFlag=false,okTip=false" >Close</button>
        </div>
        <div class="md-content">
          <div class="confirm-tips">
            <div class="error-wrap">
              <span class="error error-show" v-show="errorTip" >用户名或者密码错误</span>
              <span class="error error-show ok-show" v-show="okTip" >注册成功</span>
            </div>
            <ul v-show="loginFlag">
            ...
            <ul v-show="registerModelFlag">
              ...
              <li class="regi_form_input noMargin">
                <i class="icon IconPwd"></i>
                <input type="password" tabindex="2"  name="password" v-model="reguserPwd" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="Password" >
              </li>
            </ul>
          </div>
          <div class="login-wrap">
            <a href="javascript:;" class="btn-login" @click="login" v-show="loginFlag">登  录</a>
          </div>
          <div class="login-wrap">
            <a href="javascript:;" class="btn-login" @click="Register" v-show="registerModelFlag">注 册</a>
          </div>
        </div>
      </div>
    </div>
...
<style>
  ...
  .reg-title{ margin-left: 150px; }
  .md-title{cursor: pointer}
  .ddd-actuve{border-bottom: 2px solid #00B7FF}
  .okTip{color: #53cd5f}
</style>
<script>
